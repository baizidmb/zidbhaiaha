...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#030305] text-slate-100 selection:bg-[#ff7a00] selection:text-white flex flex-col justify-between font-sans">
      
      {/* StreamMind Top Header with Liquid Glass Style */}
      <Header
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-3 sm:px-6 lg:px-8 py-6 space-y-12">
        ...
        {/* Full-Width Cinematic Cosmic Hero Banner */}
        {!searchQuery && activeFilter === 'all' && (
          <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl bg-gradient-to-r from-[#030305] via-[#ff7a00]/10 to-[#030305] min-h-[320px] sm:min-h-[380px] flex items-center p-6 sm:p-12 glossy-shine">
            
            {/* Cosmic Orange Glow */}
            <div className="absolute right-0 top-0 w-full sm:w-1/2 h-full bg-gradient-to-l from-[#ff7a00]/20 to-transparent pointer-events-none" />

            <div className="relative z-10 max-w-2xl space-y-4">
              <div className="flex items-center space-x-3">
                <span className="px-3 py-1 rounded-full bg-[#ff7a00] text-slate-950 font-black text-[10px] uppercase tracking-wider shadow-glow-amber">
                  #1 TRENDING TODAY
                </span>
                <span className="text-xs text-white/80 font-mono flex items-center space-x-1">
                  <User className="w-3.5 h-3.5 text-[#ff7a00]" />
                  <span>{isBn ? 'শাহিদুল ইসলাম বাইজিদ দ্বারা নির্মিত' : 'Created by Shahidul Islam Baizid'}</span>
                </span>
              </div>
