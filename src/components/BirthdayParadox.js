...
export default function BirthdayParadox() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "absolute top-0 right-0 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl pointer-events-none -mr-20 -mt-20"
  }), /*#__PURE__*/React.createElement("div", {
  ...
  }, "The Birthday Paradox")), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-400 text-sm mt-1.5 font-medium"
  }, "In a room of just 23 people, there is a ", /*#__PURE__*/React.createElement("span", {
    className: "text-blue-400 font-bold"
  }, "50.7% chance"), " that two people share the exact same birthday.")), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center space-x-3"
  ...
  }), /*#__PURE__*/React.createElement("span", null, "Run Random Trial")), /*#__PURE__*/React.createElement("button", {
    ...
    className: `w-4 h-4 ${isSimulating ? 'animate-spin text-blue-400' : ''}`
  }), /*#__PURE__*/React.createElement("span", null, isSimulating ? `${monteCarloProgress}%` : '1,000 Sims')))), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 md:grid-cols-3 gap-6 mb-8"
  }, /*#__PURE__*/React.createElement("div", {
    className: "md:col-span-2 glass-card rounded-2xl p-5 border border-slate-800/80 flex flex-col justify-between"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }), /*#__PURE__*/React.createElement("span", null, "People in Room (n):")), /*#__PURE__*/React.createElement("span", {
    className: "text-2xl font-black font-mono text-blue-400 bg-blue-500/10 px-3 py-1 rounded-xl border border-blue-500/30"
    ...
    className: "flex items-center justify-between text-xs text-slate-400 font-mono mt-1"
  }, /*#__PURE__*/React.createElement("span", null, "1 person (0%)"), /*#__PURE__*/React.createElement("span", {
    className: `font-bold ${isThreshold ? 'text-blue-400 underline decoration-2' : ''}`
  }, "23 people (50.7% Threshold)"), /*#__PURE__*/React.createElement("span", null, "100 people (99.99%)"))), /*#__PURE__*/React.createElement(StatCard, {
    ...
    className: "mb-6 p-4 rounded-xl bg-blue-500/10 border border-blue-500/30 flex items-center justify-between"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center space-x-3"
  ...
  }, "Empirical Monte Carlo Result (1,000 room trials of ", numPeople, " people):")), /*#__PURE__*/React.createElement("span", {
    className: "text-lg font-extrabold font-mono text-blue-400 bg-slate-900 px-3 py-1 rounded-lg border border-slate-700"
  }, empiricalRate, "% Matches Found")), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 lg:grid-cols-12 gap-8"
  }, /*#__PURE__*/React.createElement("div", {
    className: "lg:col-span-7 glass-card rounded-2xl p-5 border border-slate-800 relative"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }), /*#__PURE__*/React.createElement("span", null, "Simulated Room Avatars (", numPeople, " People)")), trialResult && /*#__PURE__*/React.createElement("span", {
    className: `text-xs font-bold px-2.5 py-1 rounded-lg font-mono ${trialResult.hasMatch ? 'bg-cyan-500/20 text-cyan-300 border border-cyan-500/40' : 'bg-slate-800 text-slate-400'}`
  }, trialResult.hasMatch ? `✓ ${trialResult.totalMatches} Shared Birthday Match!` : 'No matches in this trial')), /*#__PURE__*/React.createElement("div", {
    ref: gridContainerRef,
    className: "relative min-h-[280px] p-2"
  }, /*#__PURE__*/React.createElement("canvas", {
    ref: canvasRef,
    className: "absolute inset-0 pointer-events-none z-10"
  }), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-5 sm:grid-cols-8 md:grid-cols-10 gap-2.5 relative z-0"
  }, trialResult?.avatars.map(av => {
    const isMatched = trialResult.matchedAvatarSet.has(av.id);
    return /*#__PURE__*/React.createElement("div", {
      key: av.id,
      "data-avatar-id": av.id,
      className: `flex flex-col items-center justify-center p-2 rounded-xl transition-all duration-300 ${isMatched ? 'bg-cyan-500/20 border-2 border-cyan-400 shadow-glow-cyan scale-105 z-20 animate-pulse-slow' : 'bg-slate-900/80 border border-slate-800 text-slate-400 hover:border-slate-700'}`
    }, /*#__PURE__*/React.createElement("div", {
      ...
      className: "text-[10px] font-mono mt-1 font-semibold text-slate-300"
    }, formatDayOfYear(av.birthday)));
  })))), /*#__PURE__*/React.createElement("div", {
    className: "lg:col-span-5 glass-card rounded-2xl p-5 border border-slate-800 flex flex-col"
  }, /*#__PURE__*/React.createElement("h3", {
  ...
  }), /*#__PURE__*/React.createElement("span", null, "Theoretical Probability Curve")), /*#__PURE__*/React.createElement("div", {
